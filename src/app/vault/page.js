            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 space-y-8">
                ...
                <p className="text-gray-500 font-medium text-lg max-w-md leading-relaxed">
                  The standout piece in the current collection. Authenticated upon arrival. A centerpiece that commands the room.
                </p>
        ...
        <section className="bg-transparent py-32 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-24 relative z-10 text-center md:text-left">
            ...
            <div className="space-y-6 flex flex-col items-center md:items-start">
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-[250px]">Figures are packed in impact-resistant casing, keeping them in mint condition upon arrival.</p>
            </div>
            <div className="space-y-6 flex flex-col items-center md:items-start">
