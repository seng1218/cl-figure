...
export default function SearchBar({ searchTerm = '', setSearchTerm, setSelectedSeries, series = [] }) {
  return (
    <section className="sticky top-28 z-40 px-6 -mt-10 mb-20">
      ...
      >
        ...
        {series.length > 0 && (
          <select
            className="hidden md:block bg-blue-600 text-white px-8 py-5 rounded-full font-black text-[10px] uppercase tracking-widest outline-none cursor-pointer hover:bg-white hover:text-black transition-colors mr-1 max-w-[180px] truncate"
